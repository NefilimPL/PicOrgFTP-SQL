...
def _worker_main(commands: Any, events: Any, cpu_percent: int) -> None:
...
class OcrWorkerProcess:
    ...
    def start(self) -> None:
        ...
        self._process = self._context.Process(
            target=_worker_main,
            args=(self._commands, self._events, self._cpu_percent),
            name="PicOrg-OCR",
            daemon=True,
        )
        self._process.start()
    ...
    def submit(self, *, run_id: str, path: str, profile_ids: Iterable[object]) -> None:
