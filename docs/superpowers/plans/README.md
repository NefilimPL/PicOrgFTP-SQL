...
| 4 | FTP i indeks plików | [plan](2026-07-27-ftp-and-file-indexing.md) | **w toku** — 7 z 8 zadań ukończonych; następne jest zadanie 8: usunięcie nieaktywnych indeksów i benchmark |
