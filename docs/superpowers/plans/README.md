...
| 4 | FTP i indeks plików | [plan](2026-07-27-ftp-and-file-indexing.md) | **w toku** — 6 z 8 zadań ukończonych; następne jest zadanie 7: zarządzany lifecycle plików tymczasowych FTP |
